...
# Add viterbox to path
sys.path.append(str(Path(__file__).parent))

from viterbox.tts import Viterbox
from viterbox.emotional_audio_profiles import list_emotional_profiles, get_emotional_audio_profile, get_profile_description
...
def demo_emotional_profiles():
    ...
    try:
        ...
        print("💡 Make sure:")
        print("   - Model files are in modelTTSLocal/")
...
You can modify emotional profiles in `viterbox/emotional_audio_profiles.py`:
