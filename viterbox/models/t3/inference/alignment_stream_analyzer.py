...
class AlignmentStreamAnalyzer:
    ...
    def step(self, logits):
        ...
        # Mới — giới hạn chiều dài alignment để tránh tích lũy vô hạn:
        self.alignment = torch.cat((self.alignment, A_chunk), dim=0)
        MAX_ALIGNMENT_FRAMES = 2000  # ~80 giây ở 25 token/sec
        if self.alignment.shape[0] > MAX_ALIGNMENT_FRAMES:
            self.alignment = self.alignment[-MAX_ALIGNMENT_FRAMES:]
